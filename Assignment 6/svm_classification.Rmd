...
A low cost means samples inside the margins are penalized less compared to higher cost. To reduce overfitting, a lower cost is ideal, and although some data points will intentionally enter the margin our algorithm won't overfit as much. It was able to predict over 50% of credit card frauds, which is impressive just given some variables.
